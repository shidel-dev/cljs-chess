...
{var pred__9086 = cljs.core._EQ_;var expr__9087 = limit;if(cljs.core.truth_(pred__9086.call(null,(1),expr__9087)))
...
{var ch = s.charAt(index);var temp__4124__auto___9093 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___9093))
{var replacement_9094 = temp__4124__auto___9093;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_9094)));
} else
{buffer.append(ch);
}
{
